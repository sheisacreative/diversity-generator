...
function openCorrectFile() {
            ...
            alert("Looks like the file is incorrect. :( \n In order to continue, please, open the Photoshop's File \"diversitygenerator_by_maianearaujo.psd\" and try again.");
            var inputFile = File.openDialog("Por please, open the Photoshop's File \"diversitygenerator_by_maianearaujo.psd\"", "*.psd", false);
            open(File(inputFile));
...
// --------------------------- CREATE THE DIALOG WINDOW --------------------------- //
    ...
    var info1 = infoText.add("statictext", undefined, "This is a Script to promote diversity.");
    var info2 = infoText.add("statictext", undefined, "To use it, fill the blanks and have fun! :)");
    var info3 = infoText.add("statictext", undefined, "More info: www.maiane.com.br/scripts");
    ...
    var numberText = numberGroup.add("statictext", undefined, "Number of Dolls:");
    var dropdownNumbers = ["1", "2", "3", "5", "10", "20", "30", "50", "70", "100"];
    var numberList = numberGroup.add("dropdownlist", undefined,  dropdownNumbers);
    var numberText2 = numberGroup.add("statictext", undefined, "P.S.: if you select a huge number");
    var numberText3 = numberGroup.add("statictext", undefined, "it may take a while to save. ;)");
    ...
    dollPositionGroup.add("statictext", undefined, "Dolls position:");
    var isInsideGroup = dollPositionGroup.add("group");
    var insideCircleDoll = isInsideGroup.add ("radiobutton", undefined, "Inside the circle");
    var outsideCircleDoll = isInsideGroup.add ("radiobutton", undefined, "In front of the circle");
    ...
    hasBackgroundColorGroup.add("statictext", undefined, "Background color:");
    var hasBackgroundColor = hasBackgroundColorGroup.add ("radiobutton", undefined, "Yes");
    var hasNotBackgroundColor = hasBackgroundColorGroup.add ("radiobutton", undefined, "No (transparent)");
    ...
    hasCircleGroup.add("statictext", undefined, "Background circle:");
    var hasCircle = hasCircleGroup.add ("radiobutton", undefined, "Yes");
    var hasNoCircle = hasCircleGroup.add ("radiobutton", undefined, "No");
    ...
    function selectColorWindow(objectGroup, hasObject, hasNotObject, pickerColor) {
        ...
        var colorButton = p1.add ("button", undefined, "Select a color");
    ...
    var savingText = thirdBlock.add("statictext", undefined, "Select the destination Folder");
    ...
    savingFolder.onClick = function () {
        ...
        if (savingPath !== null) {
            ...
            savingText.text = "Heeyy! Selecct a folder... :(";
        }
...
if(pressedOK){ //Button = OK
        ...
        alert("The dolls are done! :)\nNice job.\n\n\Developed by:\nwww.maiane.com.br");
        f.execute();
            
} else if (!pressedOK){ //Button = cancel
           
           alert("Ok... :(\nMaybe I can generate dolls to someone else.");
